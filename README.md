...
|---------|-------------|
| 号码吉凶查询 | 周易81数理解析脚本，输入手机号/车牌号出吉凶评分 |
| 空投批量查询 | 批量查 100 个钱包地址的多协议空投资格 |
| Telegram 群成员导出 | 一键导出群成员信息到 CSV |

## 🧩 Micro Products — 18 USDT

| Product | What you get |
|---------|-------------|
| 每日五行穿衣推送 | 自动算当日吉色忌色，推送到公众号/Telegram/Twitter |
| AI 面相分析 | 上传照片，AI 自动出财运/事业/婚姻/健康报告 |
| 加密货币打新监控 | 多链新币监控 + Telegram 秒级推送 |
